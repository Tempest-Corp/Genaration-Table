...
public class LandMark {
    ...
    public static final String LANGUAGES_DATA = CONFIG_FOLDER + "/language.json";
    ...
    public static final String AUTH_DATA = CONFIG_FOLDER + "/auth.zip";
    public static final String AUTH_FOLDER_NAME = "UserAuth";
